...
@Entity
@Table(name = "trainer_mapped_superclass")
public class TrainerMappedSuperClass extends UserMappedSuperClass{
    ...
    public TrainerMappedSuperClass(long userId, String name, String surname, String login, String password, Integer experience, Integer rating) {
